...
function () {
  function Darkmode(options) {
    ...
    if (darkmodeActivated === true && options.saveInCookies || darkmodeNeverActivatedByAction && preferedThemeOs) {
      ...
      document.body.querySelector('.container').classList.add('darkmode--activated');
    }

    document.body.querySelector('.container').insertBefore(button, document.body.querySelector('.container').firstChild);
    document.body.querySelector('.container').insertBefore(layer, document.body.querySelector('.container').firstChild);
    document.body.querySelector('.container').insertBefore(background, document.body.querySelector('.container').firstChild);
    this.addStyle(css);
    this.button = button;
    this.layer = layer;
  ...
  _createClass(Darkmode, [{
    ...
    value: function showWidget() {
      ...
      button.addEventListener('click', function () {
        ...
        document.body.querySelector('.container').classList.toggle('darkmode--activated');
    ...
    value: function isActivated() {
      ...
      return document.body.querySelector('.container').classList.contains('darkmode--activated');
    }
  }]);
